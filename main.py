...
while True:
    if number == '1' or number == '2' or number == '3':
        ...
        number = str(input("""Вы ввели не верное значение. Выберите один из пунктов
                    Выберите необходимый пункт меню:
                    1. Получить информацию о транзакциях из JSON-файла
                    2. Получить информацию о транзакциях из CSV-файла
                    3. Получить информацию о транзакциях из XLSX-файла
...
while True:
    if data_sort == "да" or data_sort == "нет":
        ...
        data_sort = str(input("""Вы ввели не верное значение.Введите Да или Нет.
                        Ввод: """)).lower()
if data_sort == 'да':
    ...
    while True:
        if data_sort_reverse == "по возрастанию" or data_sort_reverse == "по убыванию":
            ...
            data_sort_reverse = str(input("""Вы ввели не верное значение.Введите по возрастанию или по убыванию.
                            Ввод: """)).lower()
...
while True:
    if val_yn == "да" or val_yn == "нет":
        ...
        val_yn = str(input("""Вы ввели не верное значение.Введите Да или Нет.
                        Ввод: """)).lower()
...
while True:
    if search_yn == "да" or search_yn == "нет":
        ...
        search_yn = str(input("""Вы ввели не верное значение.Введите Да или Нет.
                        Ввод: """)).lower()
